    ...
    public List<Categoria> reportarCategoria(){
     ...
     public boolean registrarCategoria(Categoria c) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al registrar CategoriaBD....", JOptionPane.ERROR_MESSAGE);
     ...
     public boolean eliminarCategoria(Categoria c) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e, "Problemas al eliminar CategoriaBD....", JOptionPane.ERROR_MESSAGE);
     ...
     public List<Categoria> buscarCategoria(String valor){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e,"Error al buscar categoria BD...." , JOptionPane.ERROR_MESSAGE);
            return null;
        }
        return lista;
     }
