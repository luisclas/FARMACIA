...
public class ProductoBD {
    ...
    public DefaultTableModel reportarProducto() {
        ...
        String[] cabecera = {"SERIE ", "DESCRIPCION", "OBSERVACION", "DIGEMI", "CONDICION", "CATEGORIA", "MARCA", "PRESENTACION","ID_CATEGORIA","ID_MARCA","ID_MEDIDA"};
    ...
    return tabla_temporal;
     ...
     public boolean registrarProducto(Producto p) {
      ...
      public DefaultTableModel buscarProducto(String serie) {
        ...
        DefaultTableModel tabla_temporal;
        String[] titulos = {"SERIE ", "DESCRIPCION", "OBSERVACION", "DIGEMI", "CONDICION", "CATEGORIA", "MARCA", "PRESENTACION","ID_CATEGORIA","ID_MARCA","ID_MEDIDA"};
        String[] registros = new String[11];
